...
protected:
    ...
    void OnHelp_AutoCheckForUpdatesWeekly( wxCommandEvent& e );
    ...
    void OnSetupHardDiskRecording( wxCommandEvent& e );
...
private:
    ...
    //-----------------------------------------------------------------------------
    {
        ...
        miCapture_Recording_SetupHardDiskRecording,
        ...
        miHelp_AutoCheckForUpdatesWeekly,
    ...
    //-----------------------------------------------------------------------------
    {
        ...
        teAutoCheckForUpdatesWeekly
    };
    //-----------------------------------------------------------------------------
    struct HardDiskRecordingParameters
    //-----------------------------------------------------------------------------
    {
        bool boActive_;
        wxString targetDirectory_;
        TFileFormat fileFormat_;
        explicit HardDiskRecordingParameters() : boActive_( false ), targetDirectory_(), fileFormat_( ffBMP ) {}
    };
    ...
    //-----------------------------------------------------------------------------
    {
        ...
        explicit GUISetup() : verticalSplitterPosition_( -1 ), horizontalSplitterPosition_( -1 ), boDisplayShown_( true ),
            ...
            boStatusBarShown_( true ), boFitToCanvas_( false ), scrollPositionX_( -1 ), scrollPositionY_( -1 ), zoomFactor_( 0. ),
    ...
    wxMenuItem*                         m_pMICapture_Recording_SetupHardDiskRecording;
    ...
    HardDiskRecordingParameters         m_HardDiskRecordingParameters;
    ...
    void                                CollectSelectors( ComponentIterator it );
