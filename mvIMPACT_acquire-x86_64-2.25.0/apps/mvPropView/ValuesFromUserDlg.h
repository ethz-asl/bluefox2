...
//-----------------------------------------------------------------------------
{
    ...
    void                                        ConfigureItemState( const wxTreeItemId& itemId ) const;
    void                                        ExpandAll( void );
    void                                        ExpandAllChildren( const wxTreeItemId& item );
    std::vector<std::map<wxString, bool> >      EnumerateGenICamDevices( unsigned int interfaceIndex, const DeviceManager& devMgr );
    void                                        IgnoreInterfaceTechnologySetting( const std::string& technology, IgnoredInterfacesInfo& interfacesInfo );
    void                                        PopulateTreeCtrl( mvIMPACT::acquire::ComponentIterator itDrivers, const mvIMPACT::acquire::DeviceManager& devMgr );
    void                                        ReadIgnoredInterfacesInfoAndEnableAllInterfaces( void );
    void                                        ReadIgnoredInterfaceTechnologyInfoAndEnableIt( const std::string& technology );
    void                                        UpdateIgnoredInterfacesSettings( IgnoredInterfacesInfo& interfacesInfo );
    void                                        SetParentUndefinedStateIfConflictingChildrenStates( const wxTreeItemId& itemId );
    void                                        UpdateIgnoredInterfacesInfo( const wxTreeItemId& itemId );
...
public:
    ...
    explicit DriverInformationDlg( wxWindow* pParent, const wxString& title, mvIMPACT::acquire::ComponentIterator itDrivers,
